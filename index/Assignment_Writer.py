...
class Assignment_Writer:
    ...
    def __init__(self, page, string, FONT_SIZE=(32, 32), FONT_SIZE_WIDTH=33, FONT_SIZE_HEIGHT=36,
                 FONT_COLOR=(13,0,53) , tab_left = 20 , tab_right = 15):
        self.page = page
...
# a.show()
# a.save()
# AW = Assignment_Writer(page=page, string=string , FONT_SIZE=int(fontsize) , FONT_COLOR=(0,0,0) , FONT_SIZE_HEIGHT=int(fontheight) , FONT_SIZE_WIDTH=int(fontwidth) ,tab_left=int(tableft),tab_right=int(tabright))
